...
class ViewController: UIViewController, UITableViewDataSource,UITableViewDelegate {
    ...
    ***************************************************/
    var myFavoriteMovies = ["Interstellar", "The Fault in Our Stars", "Zootopia", "Inception"]
    ...
    ***************************************************/
    ...
    @IBAction func onStretch1Pressed(_ sender: UIButton) {
        ...
        ***************************************************/
        myFavoriteMovies[2] = "Toy Story"
        myFavoriteMovies.append("Finding Nemo")
        myFavoriteMovies.insert("In Time", at: 3)
        /***************************************************
